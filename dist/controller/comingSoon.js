...
exports.getComingSoonStatus = exports.getComingSoon = void 0;
...
exports.getComingSoon = getComingSoon;
const getComingSoonStatus = async (req, res) => {
    try {
        const statusData = {
            status: "development",
            progress: 65,
...
exports.getComingSoonStatus = getComingSoonStatus;
